...
\author[1]{[Author name removed for review]}
\affil[1]{[Affiliation removed for review]}
...
Data used in this study were collected from the AirKorea Open API (\url{https://www.data.go.kr}) operated by the Korea Environment Corporation. The analysis code is available at \url{[URL removed for review]}.

\begin{thebibliography}{15}

\bibitem{kim2020airkorea}
Crawford J H et al 2021 The Korea--United States Air Quality (KORUS-AQ) field study \textit{Elementa: Science of the Anthropocene} \textbf{9} 00163
