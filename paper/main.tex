...
\vspace{1em}
\noindent\textit{Submitted to Measurement Science and Technology as a Technical Design Note.}
...
\bibitem{li2019china}
Li J \textit{et al} 2019 Characterizing the aging and degradation of PM\textsubscript{2.5} continuous monitoring instruments in China's national network \textit{Atmos. Meas. Tech.} \textbf{12} 5337--5351

\bibitem{hagler2018drift}
Hagler G S W \textit{et al} 2011 Post-processing method to reduce noise while preserving high time resolution in aethalometer real-time black carbon data \textit{Aerosol Air Qual. Res.} \textbf{11} 539--546

\bibitem{wong2018crosscal}
Wong M, Djaja T and Dharmawan B 2018 Cross-calibration approaches for air quality monitoring networks: A review \textit{Sensors} \textbf{18} 3785
...
Chow J C and Watson J G 2002 Review of PM\textsubscript{2.5} and PM\textsubscript{10} apportionment for fossil fuel combustion and other sources by the chemical mass balance receptor model \textit{Energy Fuels} \textbf{16} 222--260
...
Pang Y \textit{et al} 2021 Assessing the representativeness of monitoring stations for air quality in urban areas \textit{Environ. Pollut.} \textbf{288} 117753
